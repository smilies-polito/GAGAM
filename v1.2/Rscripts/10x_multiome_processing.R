...
input_cds <- CDS_ATAC
saveRDS(input_cds, "../TMPResults/Robjects/10x_PBMC_Multiome_Controller/input_cds")
...
saveRDS(conns, "../TMPResults/Robjects/10x_PBMC_Multiome_Controller/conns")
#conns <- readRDS("../TMPResults/conns_10k_Multiome")
