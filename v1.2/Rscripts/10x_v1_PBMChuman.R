...
if (!(dir.exists("../TMPResults/classifications/10x_V1_PBMChuman"))){
  dir.create("../TMPResults/classifications/10x_V1_PBMChuman")
}

if (!(dir.exists("../TMPResults/GAM"))){
  dir.create("../TMPResults/GAM")
}
if (!(dir.exists("../TMPResults/GAM/10x_V1_PBMChuman"))){
  dir.create("../TMPResults/GAM/10x_V1_PBMChuman")
}

if (!(dir.exists("../TMPResults/metrics"))){
  dir.create("../TMPResults/metrics")
}
if (!(dir.exists("../TMPResults/metrics/10x_V1_PBMChuman"))){
  dir.create("../TMPResults/metrics/10x_V1_PBMChuman")
}

if (!(dir.exists("../TMPResults/Robjects"))){
  dir.create("../TMPResults/Robjects")
}
if (!(dir.exists("../TMPResults/Robjects/10x_V1_PBMChuman"))){
  dir.create("../TMPResults/Robjects/10x_V1_PBMChuman")
}

####### MATRIX LOADING AND ATAC ANALYSIS ########

v1_pbmc_peaks <- read.table("../TMPDATA/10x_V1_PBMChuman/atac_v1_pbmc_5k_peaks.bed")
...
#v1_pbmc_metadata <- read.table("C:/Users/loren/OneDrive - Politecnico di Torino (1)/IWBBIO/DATA/10x_V1_PBMChuman/metadata.tsv.txt")
rownames(v1_pbmc_matrix) <- v1_pbmc_peaks

conversion_error <- read.table("../DATA/10x_V1_PBMChuman/conversion_error.txt")
...
saveRDS(PBMC, "../TMPResults/Robjects/10x_V1_PBMChuman/PBMC")


####### LABELING PEAKS ######

labeled_peaks <- read.csv("../TMPresults/labeled_peaks/10x_V1_PBMChuman/cCRE_labeled_peaks.tsv", sep = "\t")
...
saveRDS(nmax, "../TMPResults/Robjects/10x_V1_PBMChuman/nmax")
