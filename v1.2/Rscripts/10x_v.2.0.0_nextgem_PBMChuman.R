...
input_cds <- new_cell_data_set(v2_pbmc_matrix)
...
saveRDS(input_cds, "../TMPResults/Robject/10X_V2_PBMC/input_cds")
...
saveRDS(conns, "../TMPResults/Robject/10X_V2_PBMC/conns")
#conns <- readRDS("../TMPResults/conns_10x_v2.0.0")
