...
v1_pbmc_peaks <- read.table("../TMPDATA/10x_V1_PBMChuman/peaks.bed")
v1_pbmc_peaks <- paste0(v1_pbmc_peaks$V1, "_", v1_pbmc_peaks$V2, "_", v1_pbmc_peaks$V3)
v1_pbmc_matrix <- Read10X_h5("../TMPDATA/10x_V1_PBMChuman/atac_v1_pbmc_5k_filtered_peak_bc_matrix.h5")
rownames(v1_pbmc_matrix) <- v1_pbmc_peaks

##### only for conversion errors
conversion_error <- read.table("../TMPDATA/10x_V1_PBMChuman/conversion_error.txt")
...
saveRDS(conns, "../TMPResults/conns_10x_V1_PBMChuman")
...
write.table(c_gam, file='../TMPResults/GAM/10x_V1_PBMChuman/cicero.tsv', quote=FALSE, sep='\t', col.names = NA)
write.table(class2, file='../TMPResults/classifications/10x_V1_PBMChuman/cicero_classifications.tsv', quote=FALSE, sep='\t', col.names = NA)
write.table(class, file='../TMPResults/classifications/10x_V1_PBMChuman/atac_classifications.tsv', quote=FALSE, sep='\t', col.names = NA)
...
write.table(c_gam, file='../TMPResults/GAM/10x_V1_PBMChuman/genescoring.tsv', quote=FALSE, sep='\t', col.names = NA)
write.table(class3, file='../TMPResults/classifications/10x_V1_PBMChuman/genescoring_classifications.tsv', quote=FALSE, sep='\t', col.names = NA)
...
labeled_peaks <- read.csv("../TMPResults/leabeled_peaks/10x_V1_PBMChuman/encodeCcreCombined_hg38_ucscLabel_classifiedPeaks.csv", sep = "\t")
...
write.table(tsv, file='../TMPResults/GAM/10x_V1_PBMChuman/gagam.tsv', quote=FALSE, sep='\t', col.names = NA)
write.table(final_GAM_first, file='../TMPResults/classifications/10x_V1_PBMChuman/gagam_classifications.tsv', quote=FALSE, sep='\t', col.names = NA)
